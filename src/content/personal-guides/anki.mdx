...
2. Next, you need to download a deck. I recommend [this deck](https://anacreondjt.gitlab.io/docs/coredeck/) for a free deck. To add it to Anki, all you need to do is open the file.
3. Now we need to change some Anki settings.
